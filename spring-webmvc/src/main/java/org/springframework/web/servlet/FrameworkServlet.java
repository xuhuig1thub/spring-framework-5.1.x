...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	private org.slf4j.Logger log=org.slf4j.LoggerFactory.getLogger(FrameworkServlet.class);
	/**
	...
	protected final void initServletBean() throws ServletException {
		...
		log.info("--initServletBean()-this.webApplicationContext="+this.webApplicationContext.getId());
	}
	...
	protected final void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.info("--protected final void doGet(HttpServletRequest, HttpServletResponse)");
		processRequest(request, response);
	}
	...
	protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.info("--void processRequest(HttpServletRequest, HttpServletResponse )");
		long startTime = System.currentTimeMillis();
