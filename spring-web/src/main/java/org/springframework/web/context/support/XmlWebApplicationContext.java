...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext{
	private org.slf4j.Logger log= org.slf4j.LoggerFactory.getLogger("XmlWebApplicationContext");
	...
	log.info("Constructor-XmlWebApplicationContext() ");
	}
	@PostConstruct
	public void a(){
	...
	protected void loadBeanDefinitions(DefaultListableBeanFactory beanFactory) throws BeansException, IOException {
		...
		timer.schedule(new TimerTask() {
			@Override
			public void run() {
				log.warn("timer.schedule    -Constructor-XmlWebApplicationContext() &   getConfigLocations()="+XmlWebApplicationContext.this.getConfigLocations()
						+"    getId()="+XmlWebApplicationContext.this.getId()+"    getDisplayName()="+XmlWebApplicationContext.this.getDisplayName()+"    \n getBeanFactory().getBeanDefinitionNames()="
						+XmlWebApplicationContext.this.getBeanFactory().getBeanDefinitionNames().length);
			}
		},3000);
	}
