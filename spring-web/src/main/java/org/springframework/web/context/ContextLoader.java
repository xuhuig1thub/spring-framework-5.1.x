...
public class ContextLoader {
	private static org.slf4j.Logger log=org.slf4j.LoggerFactory.getLogger(ContextLoader.class);
	/**
	...
	static {
		log.warn("ContextLoader static block loadProperties");
	...
	public ContextLoader() {
		log.info("-Constructor-public ContextLoader() ");
	}
	...
	public ContextLoader(WebApplicationContext context) {
		log.info("-Constructor-public ContextLoader(WebApplicationContext context) ");
	...
	protected Class<?> determineContextClass(ServletContext servletContext) {
		...
		if (contextClassName != null) {
			...
			try {
				Class<?> c=ClassUtils.forName(contextClassName, ClassUtils.getDefaultClassLoader());
				log.info("-ClassUtils.forName    return Class="+c.toString());
				return c;
			}
			catch (ClassNotFoundException ex) {
				throw new ApplicationContextException(
