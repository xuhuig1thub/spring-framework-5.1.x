...
public class CharacterEncodingFilter extends OncePerRequestFilter {
	...
	public CharacterEncodingFilter() {
		log.info("Constructor CharacterEncodingFilter()");
	}
	...
	public CharacterEncodingFilter(String encoding, boolean forceRequestEncoding, boolean forceResponseEncoding) {
		...
		log.info("Constructor-CharacterEncodingFilter(String encoding, boolean forceRequestEncoding, boolean forceResponseEncoding)");
		log.info("encoding="+encoding+"   forceRequestEncoding="+forceRequestEncoding+"    forceResponseEncoding="+forceResponseEncoding);
	}
